...
// ── Suivi salarié ─────────────────────────────────────────────
$router->get('/employment', [EmploymentController::class, 'index']);
$router->post('/api/employment/profiles', [EmploymentController::class, 'createProfile']);
$router->post('/api/employment/profiles/:id', [EmploymentController::class, 'updateProfile']);
$router->post('/api/employment/profiles/:id/delete', [EmploymentController::class, 'deleteProfile']);
$router->get('/api/employment/siren-lookup', [EmploymentController::class, 'sirenLookup']);
$router->post('/api/employment/profiles/:id/schedule', [EmploymentController::class, 'setSchedule']);
$router->post('/api/employment/profiles/:id/exceptions', [EmploymentController::class, 'addException']);
$router->post('/api/employment/profiles/:id/exceptions/:exceptionId/delete', [EmploymentController::class, 'deleteException']);
$router->post('/api/employment/profiles/:id/leave-adjustments', [EmploymentController::class, 'addLeaveAdjustment']);
$router->post('/api/employment/profiles/:id/leave-adjustments/:adjustmentId/delete', [EmploymentController::class, 'deleteLeaveAdjustment']);
$router->post('/api/employment/profiles/:id/primes', [EmploymentController::class, 'addPrime']);
$router->post('/api/employment/profiles/:id/primes/:primeId/delete', [EmploymentController::class, 'deletePrime']);
$router->post('/api/employment/profiles/:id/compute-payslip', [EmploymentController::class, 'computePayslip']);
$router->get('/employment/profiles/:id/payslip/:year/:month/pdf', [EmploymentController::class, 'payslipPdf']);
$router->post('/api/employment/profiles/:id/sick-leaves', [EmploymentController::class, 'addSickLeave']);
...
$router->post('/admin/nav-categories', [AdminController::class, 'createNavCategory']);
$router->post('/admin/nav-categories/:id', [AdminController::class, 'updateNavCategory']);
$router->post('/admin/nav-categories/:id/delete', [AdminController::class, 'deleteNavCategory']);
$router->post('/admin/nav-categories/:id/move', [AdminController::class, 'moveNavCategory']);
$router->post('/admin/nav-categories/assign-modules', [AdminController::class, 'assignNavCategoryModules']);

$router->get('/api/desktop/widgets/calendar', [DesktopController::class, 'widgetCalendar']);
$router->get('/api/desktop/widgets/shopping', [DesktopController::class, 'widgetShopping']);
$router->get('/api/desktop/info', [DesktopController::class, 'info']);
